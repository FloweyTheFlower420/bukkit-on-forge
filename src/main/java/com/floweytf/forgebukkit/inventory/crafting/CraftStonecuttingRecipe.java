...
public class CraftStonecuttingRecipe extends StonecuttingRecipe implements CraftRecipe {
    ...
    public void addToCraftingManager() {
        ...
        MinecraftServer.getServer().getCraftingManager().addRecipe(new net.minecraft.server.RecipeStonecutting(CraftNamespacedKey.toMinecraft(this.getKey()), this.getGroup(), toMinecraft(this.getInputChoice(), true), CraftItemStack.asNMSCopy(result)));
    }
}
