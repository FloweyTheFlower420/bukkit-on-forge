...
class ForgeBukkitAsyncTask extends ForgeBukkitTask {

    private final LinkedList<BukkitWorker> workers = new LinkedList<BukkitWorker>();
    private final Map<Integer, ForgeBukkitTask> runners;

    ForgeBukkitAsyncTask(final Map<Integer, ForgeBukkitTask> runners, final Plugin plugin, final Object task, final int id, final long delay) {
            ...
            workers.add(
                new BukkitWorker() {
                    ...
                    public int getTaskId() {
                        return ForgeBukkitAsyncTask.this.getTaskId();
                    }

                    @Override
                    public Plugin getOwner() {
                        return ForgeBukkitAsyncTask.this.getOwner();
                    }
                });
        }
