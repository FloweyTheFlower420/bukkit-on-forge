...
public class ForgeBukkitEquipmentSlot {
    ...
    public static EquipmentSlot toBukkit(EquipmentSlotType nms) {
        return enums[nms.ordinal()];
    }

    public static EquipmentSlotType fromBukkit(EquipmentSlot slot) {
