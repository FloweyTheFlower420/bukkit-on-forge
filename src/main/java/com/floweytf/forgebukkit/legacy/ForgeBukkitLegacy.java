package com.floweytf.forgebukkit.legacy;
...
import org.bukkit.craftbukkit.util.ForgeBukkitMagicNumbers;
 ...
 */
@Deprecated
public final class ForgeBukkitLegacy {
    ...
    public static MaterialData toLegacyData(Material material) {
        ...
        if (material.isBlock()) {
            Block block = ForgeBukkitMagicNumbers.getBlock(material);
            ...
            Item item = ForgeBukkitMagicNumbers.getItem(material);
    ...
    public static Material fromLegacy(MaterialData materialData, boolean itemPriority) {
        ...
        if (itemPriority) {
            ...
            if (item != null) {
                mappedData = ForgeBukkitMagicNumbers.getMaterial(item);
            }
        }
        ...
        if (mappedData == null && material.isBlock()) {
            ...
            if (iblock != null) {
                mappedData = ForgeBukkitMagicNumbers.getMaterial(iblock.getBlock());
            }
            ...
            if (mappedData == null) {
                ...
                if (block != null) {
                    mappedData = ForgeBukkitMagicNumbers.getMaterial(block);
                }
            }
        }
        ...
        for (Material material : Material.values()) {
            ...
            if (material.isBlock()) {
                for (byte data = 0; data < 16; data++) {
                    ...
                    blockTag = DataConverterRegistry.a().update(DataConverterTypes.BLOCK_STATE, blockTag, 100, ForgeBukkitMagicNumbers.INSTANCE.getDataVersion());
            ...
            for (byte data = 0; data < maxData; data++) {
                ...
                Dynamic<NBTBase> converted = DataConverterRegistry.a().update(DataConverterTypes.ITEM_STACK, new Dynamic<NBTBase>(DynamicOpsNBT.a, stack), -1, ForgeBukkitMagicNumbers.INSTANCE.getDataVersion());
            ...
            for (Map.Entry<Byte, Material> entry : SPAWN_EGGS.entrySet()) {
                ...
                Item newMaterial = ForgeBukkitMagicNumbers.getItem(entry.getValue());
