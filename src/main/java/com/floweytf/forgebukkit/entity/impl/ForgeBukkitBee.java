...
public class ForgeBukkitBee extends ForgeBukkitAnimals implements Bee {

    public ForgeBukkitBee(ForgeBukkitServer server, BeeEntity entity) {
        super(server, entity);
    }

    @Override
    public BeeEntity getHandle() {
        return (BeeEntity) super.getHandle();
    }

    @Override
    public String toString() {
        return "ForgeBukkitBee";
    }
    ...
    public void setCannotEnterHiveTicks(int ticks) {
        getHandle().stayOutOfHiveCountdown = ticks;
    }
}
