...
import net.minecraft.server.HangingEntity;
...
public class CraftHanging extends ForgeBukkitEntity implements Hanging {
    public CraftHanging(ForgeBukkitServer server, HangingEntity entity) {
        super(server, entity);
    }
